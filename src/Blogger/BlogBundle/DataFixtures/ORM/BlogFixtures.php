...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setTags('symfony2, php, paradise, blogger 2015');
        ...
        $blog2->setTags('pool, leaky, hacked, movie, hacking, blogger 2015');
        ...
        $blog3->setTags('misdirection, magic, movie, hacking, blogger 2015');
        ...
        $blog4->setTags('grid, daftpunk, movie, blogger 2015');
        ...
        $blog5->setTags('binary, one, zero, alive, dead, !trusting, movie, blogger 2015');
